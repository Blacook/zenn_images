...
> **ひとことメモ**：愛も憎しみも、空中で絡み合う"力の使者"である。
...
> **ひとことメモ**：時間は関係に味を染み込ませ、放置は劣化を加速する。
...
![SU(3)カラー対称性ベン図：情熱・信頼・尊敬の3色と Color Singlet](/images/aizo/fig2_su3_color.png)
...
![走る結合定数αs(Q²)の模式図：漸近的自由性と閉じ込め領域](/images/aizo/fig3_running_coupling.png)
