...
| 特性                | 意味           | 大切なポイント                           |
| :------------------ | :------------- | :--------------------------------------- |
| **C**omposable      | 組み合わせ可能 | どこでも楽に使える、依存が少ない         |
| **U**nix Philosophy | Unix哲学       | 一つのことを、見事に成し遂げる           |
| **P**redictable     | 予測可能       | 驚きがなく、意図通りに動く               |
| **I**diomatic       | 慣習的         | その言語やチームの「らしさ」を大切にする |
| **D**omain-based    | ドメインベース | 技術用語ではなく、ビジネスの言葉で語る   |
...
| 特性            | 引き継ぐSOLIDの辛さ | CUPIDが加える視点          | AIへの指示軸                       |
| :-------------- | :------------------ | :------------------------- | :--------------------------------- |
| Composable      | SRP・ISPの細分化    | 外から見た使いやすさ       | 「他の場所で使い回せるか」         |
| Unix Philosophy | SRPの内部管理コスト | 目的を一文で言い切れるか   | 「動詞＋名詞で表現できるか」       |
| Predictable     | LSPの代替可能性     | 驚き最小・副作用の明示     | 「名前と振る舞いが一致しているか」 |
| Idiomatic       | （SOLIDにない概念） | 言語・チームの慣習への共感 | 「プロジェクト慣習リストを渡す」   |
| Domain-based    | DIPの依存整理       | ビジネス語彙での命名       | 「ドメイン語彙一覧を渡す」         |
